...
public class CreateAccount extends javax.swing.JFrame {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        acc.setSortCode(Integer.parseInt(txtSortCode.getText()));
        acc.setBalance(Integer.parseInt(txtBalance.getText()));
        acc.setOverdraftLimit(Integer.parseInt(txtOverdraftLimit.getText()));
        try 
        {
            DBMethods.createAccount(acc);
        ...
        {
            JOptionPane.showMessageDialog(null, "Error: Acccount not created! - " + ex);
        }
