...
public class Deposit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Amount To Lodge");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtDepositAmt, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())))
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        String sDep  = txtDepositAmt.getText();
        
        int dep = 0;
        
        try {
           dep    = Integer.parseInt(sDep);
        }
        catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(null, "Please enter a numeric amount");
            txtDepositAmt.setText("0");
        }
        ...
        if (dep > 0) {
            ...
            try 
            {
                ...
                trans.setDescription("Deposit into " + txtAccountNumber.getText());
                trans.setCreditAmount(dep);
                trans.setDebitAmount(0);
            ...
            {
                JOptionPane.showMessageDialog(null, "Error: Account not updated! - " + ex);
            }
        }
        else {
